...
import { deleteActivity, updateActivity } from '@services/subjects/activities'
...
} from '@services/subjects/assignments'
...
function ActivityElement(props: ActivitiyElementProps) {
  ...
  async function deleteActivityUI() {
    ...
    mutate(`${getAPIUrl()}subjects/${props.subject_uuid}/meta`)
            ...
            <ToolTip content="Preview Activity" sideOffset={8}>
              <Link
                href={
                  ...
                  `/subject/${props.subject_uuid.replace(
                    'subject_',
                    ''
...
const ActivityTypeIndicator = ({
  ...
  return (
    <div
      className={`px-3 text-gray-300 space-x-1 w-28 flex ${isMobile ? 'flex-col' : ''}`}
    >
        ...
        <>
          <Link
            href={
              ...
              `/subject/${subject?.subjectStructure.subject_uuid.replace(
                'subject_',
                ''
