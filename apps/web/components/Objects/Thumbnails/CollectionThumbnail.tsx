...
import { deleteCollection } from '@services/subjects/collections'
import { getSubjectThumbnailMediaDirectory } from '@services/media/media'
        ...
        <div className="flex items-center space-x-5">
            ...
            {props.collection.subjects
              ...
              .map((subject: any, index: number) => (
                <div
                  ...
                  style={{
                    backgroundImage: `url(${getSubjectThumbnailMediaDirectory(
                      org?.org_uuid,
          ...
          <div className="flex flex-col">
            ...
            <span className="mt-1 text-sm font-medium text-indigo-200">
              {props.collection.subjects.length} subject
              {props.collection.subjects.length !== 1 ? 's' : ''}
            </span>
          </div>
        </div>
