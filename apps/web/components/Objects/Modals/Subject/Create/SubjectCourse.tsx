...
import { createNewSubject } from '@services/subjects/subjects'
...
import UnsplashImagePicker from '@components/Dashboard/Pages/Subject/EditSubjectGeneral/UnsplashImagePicker'
...
function CreateSubjectModal({ closeModal, orgslug }: any) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      const toast_loading = toast.loading('Creating subject...')
